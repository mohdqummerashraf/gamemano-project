    ...
    <>
      <div
        ...
        <div className='flex flex-col items-center justify-center bg-[#0005] absolute top-0 left-0 w-[100%] h-[100%]'>
          ...
          {tagline && <p className='w-[100%] sm:w-[60%] md:w-[60%] lg:w-[50%] xl:w-[50%] text-white text-center text-[20px] font-[400] font-routhem flex flex-row items-center' >
            <span className='w-[10%] sm:w-[15%] md:w-[20%] bg-golden-bg h-[3px] lg:w-[25%] xl:w-[25%] rounded-[10px]'></span>
           <span className='w-[80%] sm:w-[70%] md:w-[60%] lg:w-[50%] xl:w-[45%]'>The techies you love</span>
           <span className='w-[10%] sm:w-[15%] md:w-[20%] bg-golden-bg h-[3px] lg:w-[25%] xl:w-[25%] rounded-[10px] '></span></p>}
          {button &&
            <Link className='flex border-[3px] border-[#920AA8] rounded-[40px] px-[20px] py-[5px] my-[15px]'
            href='/product'
            >
